...
I hope [CBSE will not treat OSM-related students' complaints](https://www.cbse.gov.in/cbsenew/documents/FAQ-OSM_18052026.pdf) in the same cavalier fashion as other branches of government treat citizens' complaints. Though the stakes are high, especially for students, we must look at the root cause. The quality of grading is always an issue. Let me narrate an anecdote. We had one of the best teachers for social studies (a combination of history, geography, and civics). He taught us with care, referring to authentic texts from world history. Unfortunately, not a single student in our batch scored more than 50 out of 100 in the final board exam. The point is that the random graders came from different schools and had no idea about our answers. Back then, we had no provision for reevaluation. 

OSM is a step in the right direction. Still, the governance failure due to a non-transparent bidding process without any accounting led the CBSE and the Ministry of Education to face severe public scrutiny. The credibility of a system depends not only on technical fixes but on institutional accountability. AI-assisted grading, backed by strong human oversight, may reduce unfairness and enhance the CBSE board's public standing.
